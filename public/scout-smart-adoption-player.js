(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .scout-adoption-tooltip[data-floating="center"] { max-width: min(420px, calc(100vw - 32px)); padding: 18px 18px 15px; box-shadow: 0 16px 46px rgb(15 23 42 / .30), 0 5px 16px rgb(15 23 42 / .18); }
