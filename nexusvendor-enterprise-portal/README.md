...
The generated `scout-chatbot-config.local.js` is intentionally ignored. The same universal installation approach works for React and non-React customer applications.
